        ...
        routes: [
          {
            ...
            routes: [
              ...
              {
                path: '/docs/contracts/rag-api-contracts',
                component: ComponentCreator('/docs/contracts/rag-api-contracts', 'ff3'),
                exact: true,
                sidebar: "tutorialSidebar"
              },
              {
                path: '/docs/contracts/rag-configuration-management',
                component: ComponentCreator('/docs/contracts/rag-configuration-management', '4d9'),
                exact: true,
                sidebar: "tutorialSidebar"
              },
              {
                path: '/docs/contracts/rag-data-models',
                component: ComponentCreator('/docs/contracts/rag-data-models', '218'),
                exact: true,
                sidebar: "tutorialSidebar"
              },
              {
                path: '/docs/contracts/rag-error-handling',
                component: ComponentCreator('/docs/contracts/rag-error-handling', '426'),
                exact: true,
                sidebar: "tutorialSidebar"
              },
              {
                path: '/docs/contracts/rag-performance-optimization',
                component: ComponentCreator('/docs/contracts/rag-performance-optimization', '489'),
                exact: true,
                sidebar: "tutorialSidebar"
              },
              {
                path: '/docs/contracts/rag-security-implementation',
                component: ComponentCreator('/docs/contracts/rag-security-implementation', 'b9d'),
                exact: true,
                sidebar: "tutorialSidebar"
              },
              {
                path: '/docs/developer-guide/rag-developer-documentation',
                component: ComponentCreator('/docs/developer-guide/rag-developer-documentation', '3d1'),
                exact: true,
                sidebar: "tutorialSidebar"
              },
              {
              ...
              {
                path: '/docs/user-guide/rag-features-user-guide',
                component: ComponentCreator('/docs/user-guide/rag-features-user-guide', 'ac2'),
                exact: true,
                sidebar: "tutorialSidebar"
              }
            ]
